      ...
      <div className="flex gap-2">
        {demoAccounts.map((account) => (
          <button
            ...
            className="flex-1 flex items-center gap-2 px-4 py-3 rounded-xl bg-white/80 border border-dashed border-emerald-300 hover:border-emerald-500 hover:bg-emerald-50 transition-all duration-200 cursor-pointer group"
          >
            <span className="text-lg">{account.icon}</span>
            <div className="text-left">
              <p className="text-xs font-semibold text-gray-700 group-hover:text-emerald-700 transition">{account.label}</p>
              <p className="text-[10px] text-gray-400 group-hover:text-emerald-500 transition">{account.email}</p>
            </div>
          </button>
        ))}
      </div>
          ...
          <Form className="w-full max-w-sm p-8 rounded-2xl shadow-xl bg-white flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Field name="email" placeholder="Enter ID" className="w-full px-4 py-3 pr-10 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-400 text-gray-700 placeholder-gray-400" />
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Field name="password" type="password" placeholder="••••" className="w-full px-4 py-3 pr-10 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-400 text-gray-700 placeholder-gray-400 tracking-widest" />
