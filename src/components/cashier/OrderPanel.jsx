  ...
  return (
    <aside className="w-full lg:w-[330px] lg:h-dvh border-t lg:border-t-0 lg:border-l border-slate-100 bg-white flex flex-col shrink-0">
      <div className="min-h-[70px] px-4 sm:px-6 lg:px-7 flex items-center justify-between shrink-0">
        ...
        <button onClick={clearOrder} className="text-rose-400 transition duration-300 hover:scale-125 hover:text-rose-500 active:scale-95">
      ...
      <div className="px-4 sm:px-6 lg:px-7">
        <div className="h-11 rounded-2xl bg-slate-50 p-1 flex items-center">
          <button className="flex-1 h-full rounded-xl bg-white text-xs font-semibold text-emerald-500 shadow-sm transition duration-300 hover:bg-emerald-50">Dine In</button>

          <button className="flex-1 h-full rounded-xl text-xs font-semibold text-slate-300 transition duration-300 hover:text-emerald-500 hover:bg-white">Take Away</button>
        </div>
      </div>
      ...
      <div className="border-t border-slate-100 p-4 sm:p-6 lg:p-7">
        <div className="space-y-3 pb-5">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold tracking-widest text-slate-300">SERVICE TAX (5%)</span>
